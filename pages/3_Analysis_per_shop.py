...
# st.divider()
# col21, col22, col23 = st.columns([6, 1, 6])
# with col21:
#     sorted_df1 = price_changes(shop1)[6].sort_values('week ago', ascending=change).dropna(subset=['week ago'])
#     st.write(sorted_df1.head(15))
# with col22:
#     st.empty()
# with col23:
#     sorted_df2 = price_changes(shop2)[6].sort_values('week ago', ascending=change).dropna(subset=['week ago'])
#     st.write(sorted_df2.head(15))